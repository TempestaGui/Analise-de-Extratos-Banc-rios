...
public class BankStatementCSVParser implements BankStatementParser{
    ...
    @Override
    public BankTransactional parseFrom(final String line) throws DateInTheFutureException, DescriptionTooLongException,
            InvalidAmountException, InvalidDateFormat {
    ...
    @Override
    public List<BankTransactional> parseLinesFrom(final List<String> lines) throws DateInTheFutureException, DescriptionTooLongException,
            InvalidAmountException, InvalidDateFormat {
